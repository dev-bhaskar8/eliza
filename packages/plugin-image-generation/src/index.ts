...
const imageGeneration: Action = {
    ...
    handler: async (
        ...
        const IMAGE_SYSTEM_PROMPT = `You are an expert in writing prompts for AI art generation. You excel at creating detailed and creative visual descriptions that match the requested style exactly. Your output should only contain the description of the image contents, but NOT an instruction like "create an image that...". Always respect the given style parameter and avoid adding additional style elements not specified in the style parameter.`;
        const STYLE = "if nothing else specified then natural";
